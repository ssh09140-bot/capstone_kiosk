...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 20, backgroundColor: '#fff', borderBottomWidth: 1, borderColor: '#eee' },
  ...
  goShoppingButton: { paddingVertical: 12, paddingHorizontal: 24, backgroundColor: '#111', borderRadius: 8 },
  goShoppingButtonText: { color: '#fff', fontSize: 16, fontFamily: 'Pretendard-Bold' },
  cartItem: { backgroundColor: '#fff', padding: 15, borderRadius: 16, marginBottom: 15, flexDirection: 'row', alignItems: 'center', shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 5, elevation: 2 },
  itemImage: { width: 70, height: 70, borderRadius: 10, marginRight: 15, backgroundColor: '#eee' },
  itemInfo: { flex: 1, marginRight: 10 },
  itemName: { fontSize: 16, fontFamily: 'Pretendard-Bold', marginBottom: 4 },
  itemOptionsText: { fontSize: 13, color: '#666', marginBottom: 4 },
  itemPricePerOne: { fontSize: 14, color: '#888', fontFamily: 'Pretendard-Regular' },
  quantityControl: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f0f0f0', borderRadius: 20, padding: 4 },
  quantityButton: { width: 28, height: 28, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff', borderRadius: 14, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 1, elevation: 1 },
  quantityButtonText: { fontSize: 18, fontWeight: 'bold', color: '#333', lineHeight: 20 },
  quantityText: { fontSize: 15, fontFamily: 'Pretendard-Bold', marginHorizontal: 12, minWidth: 20, textAlign: 'center' },
  bottomBar: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#fff', padding: 20, paddingBottom: 34, borderTopWidth: 1, borderColor: '#eee', shadowColor: "#000", shadowOffset: { width: 0, height: -2 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 10 },
  ...
  totalPrice: { fontSize: 24, color: '#E53935', fontFamily: 'Pretendard-Bold' },
  paymentButton: { backgroundColor: '#111', padding: 18, borderRadius: 16, alignItems: 'center' },
