...
import { useNavigation } from '@react-navigation/native'; // Replaced router
...
export default function LoginScreen() {
  ...
  const navigation = useNavigation(); // Replaced router
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      navigation.replace('Home'); // Replaced router.replace with navigation.replace, navigating to 'Home' as per RootNavigator
    } catch (error: any) {
