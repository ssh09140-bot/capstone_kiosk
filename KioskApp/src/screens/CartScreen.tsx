...
export default function CartScreen() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      await api.post('/orders', orderData); // Changed to use local api instance
